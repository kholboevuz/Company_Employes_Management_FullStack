    ...
    <div class="modal-dialog add-category-modal">
      ...
      <div class="modal-content rounded-0">
        <div class="modal-header rounded-0">
          ...
          <h2 class="modal-title text-center">Topshiriq Qo'shish</h2>
        </div>
              ...
              <form role="form" action="" method="POST" autocomplete="off" enctype="multipart/form-data">
                <div class="form-horizontal">
                  <div class="form-group">
                    ...
                    <div class="">
                      <input type="text" placeholder="Topshiriq nomi" id="task_title" name="task_title" list="expense" class="form-control rounded-0" id="default" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label text-p-reset">Topshiriq mazmuni</label>
                    <div class="">
                      <textarea name="task_description" id="task_description" placeholder="Topshiriq mazmuni" class="form-control rounded-0" rows="5" cols="5"></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class="col-sm-7">
                  ...
                  <div class="form-group">
                    <label class="control-label text-p-reset">Xodim biriktirsh</label>
                    <div class="">
                      <?php 
                        $sql = "SELECT user_id, fullname FROM tbl_admin WHERE user_role = 2";
                        $info = $obj_admin->manage_all_info($sql);   
                      ?>
                      <select class="form-control rounded-0" name="assign_to" id="aassign_to" >
                        <option value="">Xodim tanlash...</option>
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-3">
                      <button type="submit" value="Upload" name="add_task_post" class="btn btn-primary rounded-0 btn-sm">Yuborish</button>
                    </div>
                    <div class="col-sm-3">
                      <button type="submit" class="btn btn-default rounded-0 btn-sm" data-dismiss="modal">Bekor qilish</button>
                    </div>
                  </div>
                </div>
              </form> 
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="well well-custom rounded-0">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="btn-group">
                <?php if($user_role == 1){ ?>
                <div class="btn-group">
                  <button class="btn btn-info btn-menu" data-toggle="modal" data-target="#myModal">Topshiriq qo'shish</button>
                </div>
              <?php } ?>
          ...
          <center ><h3>Boshqaruv bo'limi</h3></center>
          <div class="gap"></div>
                ...
                <tr>
                  ...
                  <td>
                    <?php  if($row['status'] == 1){
                        ...
                        echo '<small class="label label-success px-3">Bajarildi<span class="glyphicon glyphicon-ok" ></small>';
                        // echo "Completed <span style='color:#00af16;' class=' glyphicon glyphicon-ok' >";
                    }else{
                        echo '<small class="label label-default border px-3">Bajarilmadi <span class="glyphicon glyphicon-remove" ></small>';
                    } ?>
