...
<div class="col-lg-4 col-md-6 col-sm-12">
	...
	<center><h2 style="margin-top:1px;">Sirdaryo Yoshlar Texnoparki</h2></center>
		<form class="form-horizontal form-custom-login" action="" method="POST">
			...
			<input type="text" class="form-control rounded-0" placeholder="Xodim ID" name="username" required/>
			</div>
			...
			<input type="password" class="form-control rounded-0" placeholder="Parol" name="admin_password" required/>
			</div>
			<button type="submit" name="login_btn" class="btn btn-info pull-right">Kirish</button>
		</form>
	</div>
</div>
