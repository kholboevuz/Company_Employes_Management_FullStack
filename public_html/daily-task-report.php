    ...
    <div class="row">
      <div class="col-md-12">
        <div class="well well-custom rounded-0">
          ...
          <center ><h3>Kunlik Xodimlar ish hisoboti</h3></center>
          <div class="gap"></div>
...
<noscript>
    <div>
        ...
        <h4 class="mb-0 text-center"><b>Sirdaryo Yoshlar Texnoparki</b></h4>
        <h4 class="mb-0 text-center"><b>Xodimlarning kunlik ish hisoboti </b></h4>
        </div>
        <hr>
    </div>
</noscript>
