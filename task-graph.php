...
if(isset($_GET['delete_task'])){
  ...
  $sql = "DELETE FROM graph-info WHERE user_id = :id";
  $sent_po = "graph-info.php";
            ...
            <table class="table table-codensed table-custom">
              ...
              ?>
                <tr>
                  ...
                  <td><a title="Graph user" href="graph-info.php?user_id=<?php echo $row['user_id']; ?>"><span class="glyphicon glyphicon-edit"></span></a>&nbsp;&nbsp;</td>
                </tr>
