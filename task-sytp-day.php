...
$names = $_POST['names'];
$hisobot = $_POST['hisobot'];

$statement = $conn->prepare("INSERT INTO hisobot (names, hisobot) VALUES (:names, :hisobot)");
$statement->execute([
    'names' => $names,
    'hisobot' => $hisobot
  ]);
				 ...
				 <form method="POST">
				  <div class="form-group">
					 ...
					 <label class="control-label text-p-reset">Ismingizni kiriting</label>
						 <input type="text" name="names" id="names" class="form-control" placeholder="Ismingizni kiriting" required />
					 </div>
					 <div class="form-group">
					 <label class="control-label text-p-reset">Hisobotni to'liq kiriting</label>
						 <textarea name="hisobot" id="hisobot" class="form-control" placeholder="Hisobotni kiriting" rows="5" required></textarea>
					 </div>
					 <span id="message"></span>
					 <br>
					 <div class="form-group">
						 <input type="hidden" name="commentId" id="commentId" value="0" />
						 <button type="submit"  class="btn btn-primary"  name="submit" >Hisobot qo'shish</button>
