                ...
                ?>
                  ...
                  <div class="btn-group">
                    <form method="post" role="form" action="">
                      ...
                      <button type="submit" name="add_punch_in" class="btn btn-primary btn-lg rounded" >Ish o'rnimga keldim</button>
                    </form>
                  ...
                  dsafasdfasd
                    ...
                    <td>
                      <form method="post" role="form" action="">
                        ...
                        <button type="submit" name="add_punch_out" class="btn btn-danger btn-xs rounded" >Tugatish</button>
                      </form>
                    </td>
                  <?php }else{ ?>
